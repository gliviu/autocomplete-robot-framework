...
function readConfig(){
  ...
  settings.suggestArguments = atom.config.get(`${CFG_KEY}.suggestArguments`) || true;
  settings.includeDefaultArguments = atom.config.get(`${CFG_KEY}.includeDefaultArguments`) || false;

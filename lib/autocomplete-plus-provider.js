...
function readConfig(){
  let settings = {
    ...
    globalScopeModifier: undefined, // If used, glogal scope modifier will suggest from all available keywords, no matter current imports
    internalScopeModifier: undefined, // If used, internal scope modifier will suggest only from local resource
  };
...
function reloadAutocompleteData() {
  ...
  promise.then(function() {
    ...
    return libManager.importLibraries(PYTHON_LIBDOC_DIR, PYTHON_EXE);
  })
  .then(function() {

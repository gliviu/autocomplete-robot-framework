...
var getKeywordSuggestions = function(prefix, currentResourceKey, settings) {
  ...
  currentResourceKey = pathUtils.normalize(currentResourceKey).toLowerCase();
  ...
  if(dotNotationInfo.dotNotation){
    // Get suggestion
    scoredKeywords = keywordsRepo.score(dotNotationInfo.keywordPrefix, dotNotationInfo.resourceFilter);
    ...
    if(dotNotationInfo.keywordPrefix){
      var excludeResourceFilter = dotNotationInfo.dotNotation?dotNotationInfo.resourceFilter:undefined;
      scoredKeywords = keywordsRepo.score(dotNotationInfo.keywordPrefix, null, excludeResourceFilter);
      sortScoredKeywords(scoredKeywords, currentResourceName);

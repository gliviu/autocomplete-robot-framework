...
var reset = function(resourceFilter) {
  if(resourceFilter){
    resourceFilter = pathUtils.normalize(resourceFilter).toLowerCase();
...
var resetKeywordsMap = function(resourceKey, keywords){
  pathUtils.normalize(resourceKey).toLowerCase();
  var newKwList;
...
var processParsedData = function(parsedData, resourcePath){
  ...
  var resourceKey = pathUtils.normalize(resourcePath).toLowerCase();
  var resource = {
...
var score = function(query, resourceFilter, excludeResourceFilter) {
  resourceFilter = resourceFilter?pathUtils.normalize(resourceFilter).toLowerCase():undefined;
  excludeResourceFilter = excludeResourceFilter?pathUtils.normalize(excludeResourceFilter).toLowerCase():undefined;
